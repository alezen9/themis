  ...
  evaluate: {
    ...
    psi_y_eff: ({ moment_shape_y, psi_y }): number => {
      ...
      return throwNotApplicableLoadCase(
        "beam-column-61-m1: Annex A Cmy,0 is currently limited to uniform/linear y-axis moment shapes",
    ...
    psi_z_eff: ({ moment_shape_z, psi_z }): number => {
      ...
      return throwNotApplicableLoadCase(
        "beam-column-61-m1: Annex A Cmz,0 is currently limited to uniform/linear z-axis moment shapes",
