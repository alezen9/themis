...
export const nodes = defineNodes([
  ...
  },
  {
    ...
    source: "EC3-B.3",
    meta: { sectionRef: "Annex B", tableRef: "B.3" },
    children: [{ nodeId: "psi_y_eff" }],
  },
  {
    type: "table",
    key: "Cm_z",
  ...
  },
  {
    ...
    children: [{ nodeId: "lambda_LT" }, { nodeId: "k_c" }],
  },
  {
    type: "derived",
    key: "chi_LT_mod",
  ...
  },
  {
    ...
    children: [{ nodeId: "chi_y" }, { nodeId: "N_Rk" }, { nodeId: "gamma_M1" }],
  },
  {
    type: "derived",
    key: "n_y",
    ...
    children: [{ nodeId: "N_Ed" }, { nodeId: "N_b_y_Rd" }],
  },
  {
    type: "table",
    key: "k_yy_closed",
    valueType: { type: "number" },
    id: "k_yy_closed",
    name: "Closed-section interaction factor k_yy",
    source: "EC3-B.1",
  ...
  },
  {
    ...
    children: [{ nodeId: "chi_z" }, { nodeId: "N_Rk" }, { nodeId: "gamma_M1" }],
  },
  {
    type: "derived",
    key: "n_z",
    ...
    children: [{ nodeId: "N_Ed" }, { nodeId: "N_b_z_Rd" }],
  },
  {
    type: "table",
    key: "k_zz",
  ...
  },
  {
    ...
    valueType: { type: "number" },
    id: "k_zy_i",
    name: "I-section interaction factor k_zy",
    source: "EC3-B.2",
  ...
  },
  {
    ...
    valueType: { type: "number" },
    id: "k_zy_closed",
    name: "Closed-section interaction factor k_zy",
    expression: "\\text{class 1/2: }0.6k_{yy}\\ ;\\ \\text{class 3: }k_{yy}",
    meta: { sectionRef: "Annex B", tableRef: "B.1" },
    children: [{ nodeId: "k_yy_closed" }, { nodeId: "section_class" }],
  },
  {
    type: "derived",
    key: "k_zy",
    ...
    children: [
      { nodeId: "section_shape" },
      { nodeId: "k_zy_i", when: { eq: ["section_shape", { value: "I" }] } },
      {
        nodeId: "k_zy_closed",
        when: {
          or: [
