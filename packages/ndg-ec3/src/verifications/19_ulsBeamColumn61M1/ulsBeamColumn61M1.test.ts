...
import check_19_ulsBeamColumn61M1 from "./ulsBeamColumn61M1";
import check_20_ulsBeamColumn62M1 from "../20_ulsBeamColumn62M1/ulsBeamColumn62M1";
...
describe("check_19_ulsBeamColumn61M1", () => {
  it("computes a finite method-1 interaction ratio", () => {
    const result = evaluate(check_19_ulsBeamColumn61M1, {
  ...
  it("throws not-applicable-load-case for tension", () => {
    try {
      evaluate(check_19_ulsBeamColumn61M1, {
