...
import { computeKyy, computeKzz, computeKzyMethod1 } from "../../helpers/interaction-factors";
...
const nodes = [
  ...
  derived(p, "lambda_bar_y", "λ̄_y", ["A", "fy", "E", "Iy", "Lcr_y"]),
  derived(p, "lambda_bar_z", "λ̄_z", ["A", "fy", "E", "Iz", "Lcr_z"]),
  derived(p, "k_zy", "k_zy", ["Cm_y", "lambda_bar_y", "N_Ed", "chi_y", "N_Rk", "gamma_M1"]),
  derived(p, "k_zz", "k_zz", ["Cm_z", "lambda_bar_z", "N_Ed", "chi_z", "N_Rk", "gamma_M1"]),
  check(p, "bc_62_m1_check", "Beam-column Eq.6.62 Method 1", [
    "N_Ed", "M_y_Ed", "M_z_Ed",
    "chi_z", "chi_LT",
    "N_Rk", "M_y_Rk", "M_z_Rk",
    "gamma_M1", "k_zy", "k_zz",
...
export const ulsBeamColumn62M1: VerificationDefinition<typeof nodes> = {
  ...
  evaluate: {
    ...
    k_zy: ({ Cm_y, lambda_bar_y, N_Ed, chi_y, N_Rk, gamma_M1 }) => {
      ...
      return computeKzyMethod1(computeKyy(Cm_y, lambda_bar_y, N_Ed, NbyRd));
    },
