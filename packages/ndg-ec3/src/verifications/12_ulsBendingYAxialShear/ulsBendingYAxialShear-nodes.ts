...
export const nodes = defineNodes([
  ...
  },
  {
    ...
    children: [{ nodeId: "M_y_V_Rd" }, { nodeId: "axial_factor" }],
  },
  {
    id: "M_y_V_Rd",
    type: "formula",
  ...
  },
  {
    ...
    children: [
      { nodeId: "n_le_half_a_w" },
      {
        nodeId: "axial_factor_low",
        when: { eq: ["n_le_half_a_w", 1] },
      },
      {
        nodeId: "axial_factor_high",
        when: { eq: ["n_le_half_a_w", 0] },
      },
    ],
  },
  {
  ...
  },
  {
    id: "axial_factor_low",
    type: "derived",
    key: "axial_factor_low",
    valueType: { type: "number" },
    name: "No-reduction branch for low compression",
    expression: "1",
    children: [{ nodeId: "n_le_half_a_w" }],
  },
  {
    id: "axial_factor_high",
    type: "derived",
    key: "axial_factor_high",
    valueType: { type: "number" },
    name: "Reduction branch for n > 0.5a_w",
    expression: "\\min\\left(1,\\frac{1-n}{1-0.5a_w}\\right)",
    children: [{ nodeId: "axial_ratio" }],
  },
  {
    id: "axial_ratio",
    type: "derived",
  ...
  },
  {
    ...
    key: "a_w_raw",
    valueType: { type: "number" },
    name: "Raw area ratio for y-y branch",
    expression: "\\text{shape branch value}",
    children: [
      {
        nodeId: "a_w_raw_i",
