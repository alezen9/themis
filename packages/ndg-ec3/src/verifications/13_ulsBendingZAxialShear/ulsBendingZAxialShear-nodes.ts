...
export const nodes = defineNodes([
  {
    ...
    children: [
      ...
      { nodeId: "class3_ratio", when: { eq: ["section_class", 3] } },
    ],
  },
  {
    id: "class12_ratio",
  ...
  },
  {
    ...
    symbol: "M_{NV,z,Rd}",
    expression: "M_{z,V,Rd} \\cdot axial_factor",
    unit: "N·mm",
    meta: { sectionRef: "6.2.10", formulaRef: "(6.38)" },
    children: [{ nodeId: "M_z_V_Rd" }, { nodeId: "axial_factor" }],
  },
  {
    id: "M_z_V_Rd",
    type: "formula",
  ...
  },
  {
    ...
    children: [
      { nodeId: "n_le_a_f" },
      { nodeId: "axial_factor_low", when: { eq: ["n_le_a_f", 1] } },
      { nodeId: "axial_factor_high", when: { eq: ["n_le_a_f", 0] } },
    ],
  },
  {
    id: "n_le_a_f",
  ...
  },
  {
    ...
    valueType: { type: "number" },
    name: "No-reduction branch for n <= a_f",
    expression: "1",
    children: [{ nodeId: "n_le_a_f" }],
  },
  {
    ...
    valueType: { type: "number" },
    name: "Reduction branch for n > a_f",
  ...
  },
  {
    ...
    key: "a_f_raw",
    valueType: { type: "number" },
    name: "Raw reduction parameter by shape branch",
    expression: "\\text{shape branch value}",
    children: [
      { nodeId: "a_f_raw_i", when: { eq: ["section_shape", "I"] } },
      { nodeId: "a_f_raw_rhs", when: { eq: ["section_shape", "RHS"] } },
      { nodeId: "a_f_raw_chs", when: { eq: ["section_shape", "CHS"] } },
    ],
  },
  {
    id: "a_f_raw_i",
