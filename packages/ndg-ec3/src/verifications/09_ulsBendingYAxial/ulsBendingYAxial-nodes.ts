...
export const nodes = defineNodes([
  ...
  },
  {
    ...
    symbol: "a_{w,I}",
    expression: "\\min\\left(\\dfrac{A-2bt_f}{A},0.5\\right)",
  ...
  },
  {
    ...
    symbol: "a_{w,RHS}",
    expression: "\\min\\left(\\dfrac{A-2bt}{A},0.5\\right)",
  ...
  },
  {
    ...
    unit: "\\mathrm{MPa}",
    children: [{ nodeId: "M_y_Ed" }, { nodeId: "Wel_y" }],
  },
  {
    id: "M_y_Ed",
    type: "user-input",
