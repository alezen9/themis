...
export const nodes = defineNodes([
  ...
  },
  {
    ...
    symbol: "M_{N,y,Rd}",
    expression: "M_{pl,y,Rd} \\cdot axial_factor",
    unit: "N·mm",
    meta: { sectionRef: "6.2.9.1", formulaRef: "(6.36)" },
    children: [{ nodeId: "M_pl_y_Rd" }, { nodeId: "axial_factor" }],
  },
  {
    id: "M_pl_y_Rd",
    type: "formula",
  ...
  },
  {
    ...
    expression: "n \\leq 0.5a ? 1 : \\min\\left(1,\\frac{1-n}{1-0.5a}\\right)",
    children: [
  ...
  },
  {
    ...
    key: "n_le_half_a_w",
    valueType: { type: "number" },
    name: "Threshold indicator for n <= 0.5a",
    expression: "n \\leq 0.5a",
  ...
  },
  {
    ...
    valueType: { type: "number" },
    name: "Reduction branch for n > 0.5a",
