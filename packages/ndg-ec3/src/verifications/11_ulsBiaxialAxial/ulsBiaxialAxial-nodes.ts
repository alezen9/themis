...
export const nodes = defineNodes([
  ...
  },
  {
    ...
    key: "term_y",
    valueType: { type: "number" },
    name: "Powered interaction term about y-y",
    expression: "ratio_y^alpha_biax",
    children: [{ nodeId: "ratio_y" }, { nodeId: "alpha_biax" }],
  },
  {
    id: "ratio_y",
    type: "derived",
  ...
  },
  {
    ...
    symbol: "M_{N,y,Rd}",
    expression: "M_{pl,y,Rd}*axial_y_factor",
    unit: "N·mm",
    meta: { sectionRef: "6.2.9.1", formulaRef: "(6.36)" },
    children: [{ nodeId: "M_pl_y_Rd" }, { nodeId: "axial_y_factor" }],
  },
  {
    id: "M_pl_y_Rd",
    type: "formula",
  ...
  },
  {
    ...
    expression: "min(1,axial_y_ratio)",
    children: [{ nodeId: "axial_y_ratio" }],
  },
  {
    id: "axial_y_ratio",
    type: "derived",
    key: "axial_y_ratio",
    valueType: { type: "number" },
    name: "Axial reduction ratio about y-y",
    expression: "(1-n)/(1-0.5*a_w)",
  ...
  },
  {
    ...
    key: "a_w_raw",
    valueType: { type: "number" },
    name: "Raw y-y reduction ratio by section shape",
  ...
  },
  {
    ...
    key: "term_z",
    valueType: { type: "number" },
    name: "Powered interaction term about z-z",
    expression: "ratio_z^beta_biax",
    children: [{ nodeId: "ratio_z" }, { nodeId: "beta_biax" }],
  },
  {
    id: "class12_ratio",
    type: "derived",
    ...
    expression: "term_y+term_z",
    children: [{ nodeId: "term_y" }, { nodeId: "term_z" }],
  },
  {
    id: "ratio_z",
    type: "derived",
  ...
  },
  {
    ...
    symbol: "M_{N,z,Rd}",
    expression: "M_{pl,z,Rd}*axial_z_factor",
    unit: "N·mm",
    meta: { sectionRef: "6.2.9.1", formulaRef: "(6.38)" },
    children: [{ nodeId: "M_pl_z_Rd" }, { nodeId: "axial_z_factor" }],
  },
  {
    id: "M_pl_z_Rd",
    type: "formula",
  ...
  },
  {
    ...
    expression: "n<=a_f ? 1 : 1-axial_z_ratio^2",
    children: [
      { nodeId: "n" },
      { nodeId: "a_f" },
  ...
  },
  {
    ...
    expression: "min(a_f_raw,0.5)",
    children: [{ nodeId: "a_f_raw" }],
  },
  {
    id: "a_f_raw",
    type: "derived",
    key: "a_f_raw",
    valueType: { type: "number" },
    name: "Raw z-z reduction ratio by section shape",
    expression: "\\text{shape branch value}",
    children: [
      {
        nodeId: "a_f_raw_i",
