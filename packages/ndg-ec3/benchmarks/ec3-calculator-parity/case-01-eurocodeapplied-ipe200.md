...
- Scenario: IPE200, Class 1, L=5 m, N=-100 kN (compression), Vy=10 kN, Vz=50 kN, My=20 kNm, Mz=5 kNm.

## Sign Convention Mapping
- Source convention: compression negative.
- Engine convention in this implementation: compression negative.
- Applied mapping: `N_Ed_engine = N_source`.

## Expected Outcomes by Check
- 01 tension: `u = 0.000`
- 02 compression: `u = 0.104`
...
- 15 flexural buckling y: `u = 0.130`
- 16 flexural buckling z: `u = 0.997`
- 17 torsional/torsional-flexural buckling: `u = 0.186`
- 18 lateral torsional buckling: `u = 0.753`
- 19 beam-column Eq.6.61 Method 1: `u = 4.618`
- 20 beam-column Eq.6.62 Method 1: `u = 4.100`
- 21 beam-column Eq.6.61 Method 2: `u = 1.417`
- 22 beam-column Eq.6.62 Method 2: `u = 2.444`
