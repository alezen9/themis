...
46. `N_cr_yProduct` (derived) = 4.027095e+13
47. `N_cr_y` (derived) = 4.474550e+6
48. `N_cr_zProduct` (derived) = 2.951407e+12
49. `N_cr_z` (derived) = 327934.055566862
50. `ip2Product` (derived) = 2.085400e+7
51. `ip2` (derived) = 7322.331460674
52. `ncr_t_warpProduct` (derived) = 2.692329e+16
53. `ncr_t_warp` (derived) = 2.991477e+9
54. `ncr_tProduct` (derived) = 8.645277e+9
55. `N_cr_T` (derived) = 1.180673e+6
56. `N_cr_TF` (derived) = 327934.055566862
57. `eulerProduct` (derived) = 2.951407e+12
58. `euler_term` (derived) = 327934.055566862
59. `torsion_ratio` (derived) = 9122.191011236
60. `torsionProduct` (derived) = 5.088420e+16
61. `torsionFactor` (derived) = 2.951407e+12
...
67. `lambda_bar_0Product` (derived) = 7.831300e+7
...
84. `cm_ampProduct` (derived) = 1.286386624
85. `cm_ampFactor` (derived) = 2.286386624
86. `cm_amp` (derived) = 0.562628652
87. `cmReserve` (derived) = 0.32403671
88. `Cm_y` (table) = 0.807299069
89. `Cm_z` (table) = 0.631635141
90. `Cm_y_aug` (derived) = 0.915718134
91. `cm_ltProduct` (derived) = 0.835527345
...
99. `alpha_LT_eff` (derived) = 0.34
100. `chi_LT` (derived) = 0.57189179
101. `f_LT` (derived) = 1
102. `chi_LT_mod` (derived) = 0.57189179
103. `lambda_bar_y` (derived) = 0.475345627
104. `lambda_bar_z` (derived) = 1.755864139
105. `n_pl` (derived) = 0.19781611
106. `wy` (derived) = 1.103
107. `wz` (derived) = 1.154
108. `lambda_bar_max` (derived) = 1.755864139
109. `b_LT` (derived) = 0.079874159
110. `c_LT` (derived) = 1.019774317
111. `d_LT` (derived) = 0.333325978
112. `e_LT` (derived) = 0.733142732
113. `C_yy` (derived) = 0.906618314
114. `C_yz` (derived) = 0.894626928
115. `C_zy` (derived) = 0.820592285
116. `C_zz` (derived) = 0.886258414
117. `k_yyReserve` (derived) = 0.955302764
118. `k_yy` (derived) = 0.932113782
119. `k_zzReserve` (derived) = 0.390121286
120. `k_zz` (derived) = 1.826864201
121. `k_yz` (derived) = 1.110685416
122. `bc_61_term1Factor` (derived) = 942042.368857003
123. `bc_61_term1` (derived) = 0.212304676
124. `bc_61_term2Factor` (derived) = 4.478656e+7
125. `bc_61_term2` (derived) = 0.416247082
126. `bc_61_term3Factor` (derived) = 2.048350e+7
127. `bc_61_term3` (derived) = 0.271117098
128. `bc_61_m1_check` (check) = 0.899668856
...
```json
{
  ...
  "bc_61_term1Factor": 942042.3688570027,
  "bc_61_term2": 0.4162470821015102,
  "bc_61_term2Factor": 44786561.75300539,
  "bc_61_term3": 0.27111709813847684,
  "bc_61_term3Factor": 20483500,
  "beta_LT": 0.75,
