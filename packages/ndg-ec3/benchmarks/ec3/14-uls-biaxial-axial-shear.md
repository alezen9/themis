...
16. `V_pl_zProduct` (derived) = 505520
17. `V_plFactor` (derived) = 1.732050808
18. `V_pl_z_Rd` (formula) = 291862.10808074
19. `V_pl_yProduct` (derived) = 1.011040e+6
...
43. `M_y_VProduct` (derived) = 7.831300e+7
44. `M_y_V_Rd` (formula) = 7.831300e+7
45. `axial_yProduct` (derived) = 0.80218389
46. `axial_yFactor` (derived) = 1
47. `axial_y_ratio` (derived) = 0.80218389
48. `axial_y_factor` (derived) = 0.80218389
49. `M_NV_y_Rd` (formula) = 6.282143e+7
50. `Wpl_z_web` (derived) = 1993.6
51. `Wpl_z_flange` (derived) = 55706.4
52. `M_z_rho_mod` (derived) = 0
53. `Wpl_z_eff` (derived) = 57700
54. `M_z_VProduct` (derived) = 2.048350e+7
55. `class_guard` (derived) = 1
56. `M_z_V_Rd` (derived) = 2.048350e+7
57. `n_minus_af` (derived) = 0.19781611
58. `one_minus_af` (derived) = 1
59. `axial_z_ratio` (derived) = 0.19781611
60. `axial_z_ratio_sq` (derived) = 0.039131213
61. `axial_z_factor` (derived) = 0.960868787
62. `n_le_af` (derived) = 0
63. `M_NV_z_Rd` (formula) = 1.968196e+7
64. `alpha_biax` (derived) = 2
65. `beta_biax` (derived) = 1
66. `abs_M_y_Ed` (derived) = 2.000000e+7
67. `abs_M_z_Ed` (derived) = 5.000000e+6
68. `ratio_y` (derived) = 0.318362714
69. `ratio_z` (derived) = 0.254039794
70. `term_y` (derived) = 0.101354818
71. `term_z` (derived) = 0.254039794
72. `biaxial_axial_shear_check` (check) = 0.355394612
...
```json
{
  ...
  "beta_biax": 1,
  "biaxial_axial_shear_check": 0.35539461209241285,
  "class_guard": 1,
  "fy": 355,
  "gamma_M0": 1,
  "M_NV_y_Rd": 62821426.966292135,
  "M_NV_z_Rd": 19681955.78965524,
  "M_y_Ed": 20000000,
  "M_y_rho_mod": 0,
