...
| `Wpl_z_eff_mm3`               | 6.2.8 (6.30)     | reduced plastic modulus about z  | none                |
| `M_z_V_Rd_Nmm`                | 6.2.8 (6.30)     | `Wpl_z_eff_mm3 * f_y / gamma_M0` | none                |
| `M_NV_z_Rd_Nmm`               | 6.2.9.1 (6.38)   | `M_z,V,Rd * k_z`                 | none                |
