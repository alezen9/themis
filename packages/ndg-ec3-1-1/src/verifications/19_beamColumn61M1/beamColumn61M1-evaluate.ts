...
export const evaluate = defineEvaluators(nodes, {
  ...
  abs_N_Ed_N: ({
    ...
    if (N_Ed_N > 0) {
      throw new Ec3VerificationError({
        type: "not-applicable-load-case",
        message:
          "beam-column-61-m1: check is only applicable for compression (N_Ed_N < 0)",
  ...
  N_cr_y_N: ({ pi, E_MPa, Iy_mm4, L_mm, k_y }) => {
    ...
    if (!Number.isFinite(denominator) || denominator <= 0) {
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message:
          "beam-column-61-m1: denominator (L_mm*k_y)^2 must be > 0 (division by zero)",
      });
    }
  ...
  N_cr_z_N: ({ pi, E_MPa, Iz_mm4, L_mm, k_z }) => {
    ...
    if (!Number.isFinite(denominator) || denominator <= 0) {
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message:
          "beam-column-61-m1: denominator (L_mm*k_z)^2 must be > 0 (division by zero)",
      });
    }
  ...
  ip2_mm2: ({ Iy_mm4, Iz_mm4, A_mm2 }) => {
    if (A_mm2 <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: A_mm2 must be > 0",
      });
  ...
  N_cr_T_N: ({
    ...
    if (Iy_mm4 <= 0 || Iz_mm4 <= 0 || It_mm4 <= 0 || Iw_mm6 <= 0) {
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message:
          "beam-column-61-m1: Iy_mm4, Iz_mm4, It_mm4 and Iw_mm6 must be > 0",
      });
    }
  ...
  M_cr_Nmm: ({
    ...
    if (!Number.isFinite(lcrLT) || lcrLT <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: L_mm*k_LT must be > 0",
      });
    if (Iz_mm4 <= 0 || It_mm4 <= 0 || Iw_mm6 <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: Iz_mm4, It_mm4 and Iw_mm6 must be > 0",
      });
    if (C1 <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
  ...
  ncr_y_ratio: ({ abs_N_Ed_N, N_cr_y_N }) => {
    if (N_cr_y_N <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: N_cr_y_N must be > 0",
      });
  ...
  ncr_z_ratio: ({ abs_N_Ed_N, N_cr_z_N }) => {
    if (N_cr_z_N <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: N_cr_z_N must be > 0",
      });
  ...
  ncr_t_ratio: ({ abs_N_Ed_N, N_cr_T_N }) => {
    if (N_cr_T_N <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: N_cr_T_N must be > 0",
      });
  ...
  ncr_tf_ratio: ({ abs_N_Ed_N, N_cr_TF_N }) => {
    if (N_cr_TF_N <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: N_cr_TF_N must be > 0",
      });
  ...
  chi_LT: ({
    ...
    if (M_cr_Nmm <= 0)
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
        message: "beam-column-61-m1: M_cr_Nmm must be > 0",
      });
    const W_y = section_class >= 3 ? Wel_y_mm3 : Wpl_y_mm3;
  ...
  bc_61_term1: ({ abs_N_Ed_N, chi_y, N_Rk_N, gamma_M1 }) => {
    const denominator = (chi_y * N_Rk_N) / gamma_M1;
    if (!Number.isFinite(denominator) || denominator <= 0) {
      throw new Ec3VerificationError({
        type: "invalid-input-domain",
  ...
  bc_61_term2: ({ k_yy, abs_M_y_Ed_Nmm, chi_LT_mod, M_y_Rk_Nmm, gamma_M1 }) => {
    ...
    return k_yy * (abs_M_y_Ed_Nmm / denominator);
  },
  bc_61_term3: ({ k_yz, abs_M_z_Ed_Nmm, M_z_Rk_Nmm, gamma_M1 }) => {
    ...
    return k_yz * (abs_M_z_Ed_Nmm / denominator);
  },
