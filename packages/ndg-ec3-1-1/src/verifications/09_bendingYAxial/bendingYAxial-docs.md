...
| ----------------------- | -------------- | ------------------------------------- | --------------------- | ----------- | --------- |
| `N_pl_Rd_N`             | 6.2.4 (6.10)   | `A_mm2 * f_y / gamma_M0`              | none                  |
| `n`                     | 6.2.9.1        | `                                     | N_Ed                  | / N_pl,Rd`  | none      |
| `a_w_i`                 | 6.2.9.1        | `min((A_mm2 - 2b t_f) / A_mm2, 0.5)`  | `section_shape = I`   |
| `a_w_rhs`               | 6.2.9.1        | `min((A_mm2 - 2b t_mm) / A_mm2, 0.5)` | `section_shape = RHS` |
...
| `M_N_y_Rd_Nmm`          | 6.2.9.1 (6.36) | `M_pl,y,Rd * k_y`                     | none                  |
| `utilization_class12`   | 6.2.9.1        | `                                     | M_y,Ed                | / M_N,y,Rd` | class 1/2 |
| `sigma_N_MPa`           | 6.2.9.2        | `                                     | N_Ed                  | / A_mm2`    | class 3   |
| `sigma_M_y_MPa`         | 6.2.9.2        | `                                     | M_y,Ed                | / W_el,y`   | class 3   |
| `sigma_x_class3_MPa`    | 6.2.9.2        | `sigma_N_MPa + sigma_M_y_MPa`         | class 3               |
