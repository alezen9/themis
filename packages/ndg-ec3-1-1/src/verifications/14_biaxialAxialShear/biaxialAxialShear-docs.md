...
| `Wpl_y_eff_mm3`, `M_y_V_Rd_Nmm`, `M_NV_y_Rd_Nmm` | 6.2.10 + 6.2.9.1      | y reduced chain                | shape/threshold     |
| `Wpl_z_eff_mm3`, `M_z_V_Rd_Nmm`, `M_NV_z_Rd_Nmm` | 6.2.8 + 6.2.9.1       | z reduced chain                | class/threshold     |
