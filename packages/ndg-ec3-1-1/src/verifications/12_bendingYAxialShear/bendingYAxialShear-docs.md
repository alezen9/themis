...
| `Wpl_y_eff_mm3`               | 6.2.10 (6.45 intent) | effective plastic modulus under shear | shape (`I/RHS/CHS`) |
| `M_y_V_Rd_Nmm`                | 6.2.10 (6.45)        | `Wpl_y_eff_mm3 * f_y / gamma_M0`      | none                |
| `M_NV_y_Rd_Nmm`               | 6.2.9.1 (6.36)       | `M_y,V,Rd * k_y`                      | none                |
...
|  `- abs_M_y_Ed_Nmm / M_NV_y_Rd_Nmm
`- utilization_class3 (class 3)
   `- sigma_v_class3_MPa / sigma_limit_MPa
```
