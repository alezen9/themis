...
export const nodes = defineNodes([
  ...
  },
  {
    ...
    children: [{ nodeId: "abs_M_y_Ed_Nmm" }, { nodeId: "M_NV_y_Rd_Nmm" }],
  },
  {
    id: "M_NV_y_Rd_Nmm",
    type: "formula",
  ...
  },
  {
    ...
    expression: "\\sqrt{\\sigma_x^2+3(\\tau_y_MPa^2+\\tau_z_MPa^2)}",
    unit: "\\mathrm{MPa}",
    children: [
      { nodeId: "sigma_x_class3_MPa" },
      { nodeId: "tau_y_MPa" },
      { nodeId: "tau_z_MPa" },
    ],
  },
  {
    ...
    expression: "\\sigma_N_MPa+\\sigma_{M,y}",
    unit: "\\mathrm{MPa}",
    children: [{ nodeId: "sigma_N_MPa" }, { nodeId: "sigma_M_y_MPa" }],
  },
  {
    id: "sigma_N_MPa",
    type: "derived",
  ...
  },
  {
    ...
    unit: "\\mathrm{MPa}",
    children: [{ nodeId: "abs_V_z_Ed_N" }, { nodeId: "Av_z_mm2" }],
  },
  {
    id: "sigma_limit_MPa",
    type: "formula",
